...
<template>
  <section v-if="currentGuid">
    ...
    <div class="flex items-center">
      ...
      <div v-if="copied" class="flex items-center py-2 px-6 mb-4 text-[#0D162B] bg-white bg-opacity-80 rounded-full shadow-sm fixed top-2 right-2 transition-all" role="alert">
